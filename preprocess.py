...
if __name__ == "__main__":
    ...
    # with open('/media/tts/f31fb3cf-8485-4868-8b63-75c78781b13d/App/asmltts_beta/db/chj_22050/validation.txt', 'r') as f:
    #     lines = f.readlines()
    #     for line in tqdm(lines):
    #         fname, txt = line.split('|')
    ...
    # get rs
    # with open('db/chj_22050/train.txt', 'r') as f:
    #     lines = f.readlines()
    #     rs_min = 50
    #     rs_max = 0
    #     rs_list = []
    ...
    # resample
    # import librosa
    # with open('db/chj/train.txt', 'r') as f:
    #     lines = f.readlines()
    #     for line in tqdm(lines):
    #         fname, txt = line.split('|')
    #         # fname_in = fname
    ...
    #         # audio = (audio * 32767).astype(int)
    #
    #         out_name = fname.replace('chj', 'chj_22050')
    #
    #         # out_name = fname.replace('.wav', '_trim.wav')
