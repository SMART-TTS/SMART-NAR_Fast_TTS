...
#from ko_dictionary import english_dictionary, etc_dictionary
from utils.text.g2p2_demo import runKoG2PTest
...
def tokenize(text, as_id=True, symbol_type=0, debug=False):
    ...
    if symbol_type:
        ...
        pre_tokens = runKoG2PTest(text, '/media/tts/f31fb3cf-8485-4868-8b63-75c78781b13d/App/asmltts_beta/utils/text/rulebook.txt').split(' ')
        if as_id:
