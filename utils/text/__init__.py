...
from utils.text.symbols import symbols, en_symbols, PAD, EOS
from utils.text.korean import jamo_to_korean
...
def get_symbols(cleaners='korean_cleaners'):
    if cleaners == 'english_cleaners':
...
def text_to_sequence(text, as_token=False):
    cleaner_names = [x.strip() for x in hparam.cleaners.split(',')]
...
if __name__ == "__main__":
  ...
  # print(_symbol_to_id, '\n')
  # text1 = u'printing'
  # text1 = text_to_sequence(text1.rstrip())
  ...
  text2 = text_to_sequence(text2.rstrip())
  print(_symbol_to_id, '\n')
